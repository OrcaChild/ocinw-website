...
- Bottle caps and lids, which separate from their bottles and are counted separately
- Straws and stirrers
...
**What to look for:**
- Cigarette filters (the white/tan fibrous tip, which is not cotton; it's actually cellulose acetate plastic)
...
**Why it matters:** Foam is essentially 98% air, so it floats well and travels far. It never fully biodegrades; it only breaks into smaller particles. California's statewide ban on polystyrene food containers went into effect in 2022, but pre-ban material is still abundant in the environment.

### 5. Fishing Gear ("Ghost Gear")

**What to look for:**
- Monofilament fishing line, the clear, thin line used in recreational fishing
- Braided fishing line, thicker and colorful, often green or blue
...
- Record as you go, not at the end, because memory fades fast
- When in doubt between categories, pick the closest match and add a note
- Count carefully, because the data is only useful if it's accurate
