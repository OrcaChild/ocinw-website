...
Kelp attaches to rocky seafloor using root-like structures called **holdfasts**, which are not roots in the plant sense, because they don't absorb nutrients. Instead, kelp absorbs everything it needs directly from the surrounding water: sunlight (for photosynthesis), carbon dioxide, nitrogen, phosphorus, and trace minerals.
